  ...
  <div class="add-data-wrapper">
    ...
    <el-card class="box-card">
      ...
      <div class="step-one">
        ...
        <ul>
          <li>
            <a :href="macUrl"><i class="iconfont vic-mac"></i><span>mac版S3-Browser</span></a>
          </li>
          <li>
            <a :href="windowsUrl"
              ><i class="iconfont vic-windowsicon"></i><span>Windows版S3-Browser</span></a
            >
          </li>
          <li class="intro-txt">
            <a :href="useDocs"><i class="iconfont vic-word"></i><span>使用说明</span></a>
          </li>
        </ul>
      </div>
      <div class="step-two">
        ...
        <ul>
          <li>
            ...
            <el-tooltip class="item" effect="dark" :content="tooltipDesc" placement="right-start">
              <el-button
                ><i @click="copyActiveCode($event, userInfo.uid)">{{ userInfo.uid }}</i></el-button
              >
            </el-tooltip>
          </li>
          <li>
            ...
            <el-tooltip class="item" effect="dark" :content="tooltipDesc" placement="right-start">
              <el-button
                ><i @click="copyActiveCode($event, userInfo.endpoint)">{{
                  userInfo.endpoint
                }}</i></el-button
              >
            </el-tooltip>
          ...
          <li>
            ...
            <el-tooltip class="item" effect="dark" :content="tooltipDesc" placement="right-start">
              <el-button
                ><i @click="copyActiveCode($event, userInfo.accessKey)">{{
                  userInfo.accessKey
                }}</i></el-button
              >
            </el-tooltip>
          ...
          <li>
            ...
            <el-tooltip class="item" effect="dark" :content="tooltipDesc" placement="right-start">
              <el-button
                ><i @click="copyActiveCode($event, userInfo.secretKey)">{{
                  userInfo.secretKey
                }}</i></el-button
              >
            </el-tooltip>
      ...
      <p>
        如果您的数据量特别大（超过20G），请发送邮件至xtian@sstir.cn，我们将安排服务专员与您取得联系。
      </p>
      <p>
...
export default {
  ...
  computed: {
    ...
    url() {
      return `${appConfig.ucloudUrl}?accesskey=${this.userInfo.accessKey}&secretkey=${
