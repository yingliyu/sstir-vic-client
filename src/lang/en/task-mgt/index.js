...
export default {
  ...
  add: {
    ...
    desc3: '3. The whole process generally takes about 2-3 hours, varied by input file sizes. When task is completed, you can download PDF report on My tasks page. ',
