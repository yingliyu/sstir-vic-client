...
export default {
  ...
  add: {
    ...
    desc3: '3. The whole process generally takes about 0.5-3 hours, varied by library preparation and sequencing depth. When task is completed, you can download PDF report on My tasks page. ',
